...
- **Modularization**: Always respect the module boundaries. Do not put page-specific rendering logic in `mod.rs`. Use the dedicated files in `pages/` (`list.rs`, `view.rs`, etc.).

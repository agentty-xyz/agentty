...
Re-emit your complete response as a single valid JSON object matching the schema below.
Do not include any text before or after the JSON object. Do not wrap it in markdown code
fences.

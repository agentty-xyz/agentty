//! App-wide background task helpers for version checks and review-assist
//! generation.
//!
...
/// Resolves the forge remote for session-linked review-comment loading.
...
mod tests {
    ...
    /// Builds one GitHub remote fixture for forge task tests.

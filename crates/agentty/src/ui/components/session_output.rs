...
impl<'a> SessionOutput<'a> {
    ...
    /// Sets the focused-review status message rendered when review text is not
    /// available.
    #[must_use]
    ...
    /// Sets focused-review text generated by an agent.
    #[must_use]
    ...
    fn output_text(
        ...
        if done_session_output_mode == DoneSessionOutputMode::FocusedReview {
            ...
            return "Focused review is not available.".to_string();
        }
...
mod tests {
    ...
    fn test_output_lines_focused_review_mode_shows_unavailable_message_without_assisted_text() {
        ...
        // Assert
        assert!(text.contains("Focused review is not available."));
    }
    ...
    fn test_output_lines_focused_review_mode_prefers_assisted_text() {
        ...
        let mut session = session_fixture();
        session.status = Status::Review;
        let assisted_text = "## Focused Review\n\n- Assisted insight";
        ...
        let lines = SessionOutput::output_lines(
            ...
            session.status,
            DoneSessionOutputMode::FocusedReview,
            Some("Preparing focused review with agent help..."),
            Some(assisted_text),
            None,
        );
        let text = lines
        ...
        assert!(!text.contains("Preparing focused review with agent help..."));
    }
    ...
    fn test_builder_methods() {
        ...
        let focused_review_status_message = "Preparing focused review...";
        let focused_review_text = "Assisted focused review";

...
impl<'a> ReviewDeadlineClient<'a> {
    ...
    pub(crate) fn new(client: &'a dyn OneShotClient, duration: Duration) -> Self {
        Self {
            client,
...
#[async_trait]
impl OneShotClient for ReviewDeadlineClient<'_> {

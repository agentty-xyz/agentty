...
struct SessionListJoinRow {
    ...
    review_request_merge_commit_sha: Option<String>,
...
impl SessionListJoinRow {
    ...
    fn into_session_list_row(self) -> SessionListRow {
        let Self {
            ...
            review_request_merge_commit_sha,
        ...
        let review_request = SessionReviewRequestJoinRow {
            ...
            merge_commit_sha: review_request_merge_commit_sha,
...
SELECT session.base_branch AS base_branch,
       ...
       session_review_request.merge_commit_sha AS review_request_merge_commit_sha,
    ...
    impl SessionJoinRow {
        ...
        fn fixture_for_test() -> Self {
            Self {
                ...
                review_request_merge_commit_sha: Some("merge123".to_string()),

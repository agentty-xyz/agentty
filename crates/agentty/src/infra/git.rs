...
pub use sync::{
    ...
    branch_upstream_reference, commit_all, commit_all_preserving_single_commit,
    ...
    push_current_branch, push_current_branch_to_remote_branch, remote_branch_exists, stage_all,

ALTER TABLE project ADD COLUMN created_at      INTEGER NOT NULL DEFAULT (unixepoch());
...
ALTER TABLE project ADD COLUMN updated_at      INTEGER NOT NULL DEFAULT (unixepoch());

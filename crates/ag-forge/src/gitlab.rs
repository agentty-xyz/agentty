...
impl ReviewRequestAdapter for GitLabReviewRequestAdapter {
    ...
    /// normalizes diff notes plus review-request-wide notes for a
    /// session-linked review-comment page.
...
/// Minimal GitLab note author data shown with session-linked review comments.
#[derive(Clone, Deserialize)]

...
| `TerminalOperation`        | `runtime/terminal.rs`                        | Raw mode, alternate screen, keyboard enhancement, and mouse-capture escape sequences.                                                                                                                                                                                                                                                                                                                                              |
| `MouseCapture`             | `runtime/terminal.rs`                        | Live mouse-capture toggling reconciled with the `Mouse Support` setting; `NoopMouseCapture` backs `run_with_backend`.                                                                                                                                                                                                                                                                                                              |

...
| `SessionBackend`           | `crates/ag-session/src/service.rs`           | Frontend-neutral session creation, complete by-id lookup, messaging, merge, and review-request operations implemented by host applications.                                                                                                                     |

...
Focused-review tests inject a short total deadline around `OneShotClient` to verify
cancellation and retained partial findings. App-server fixtures verify fresh
conversation context on reused processes, restart fallbacks, and cleanup at the end of a
review.

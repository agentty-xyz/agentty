...
| `ReviewRequestClient`  | `crates/ag-forge/src/client.rs`              | GitHub/GitLab review-request orchestration and project-scoped assigned GitHub issue search through `gh`/`glab`.                                                                    |

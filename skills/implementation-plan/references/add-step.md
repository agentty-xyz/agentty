...
Insert one new roadmap step into `## Implementation Steps` with the canonical section layout and a stable UUID.
...
4. Insert a new step block in `## Implementation Steps` using the canonical layout from `skills/implementation-plan/SKILL.md`, give it a fresh UUID, and place it where the execution order should reflect the new slice.
